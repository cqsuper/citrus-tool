...
import com.alibaba.ide.plugin.eclipse.springext.hyperlink.detector.JavaHyperlinkDetector.JavaElementHyperlink;
...
public class HyperlinkDetectorUtil {
    ...
    private static IHyperlink[] createContributionHyperlinks(IRegion region, final Schema schema,
        ...
        if(className!=null){
        	IJavaProject javaProject = SpringExtPluginUtil.getJavaProject(project, true);
